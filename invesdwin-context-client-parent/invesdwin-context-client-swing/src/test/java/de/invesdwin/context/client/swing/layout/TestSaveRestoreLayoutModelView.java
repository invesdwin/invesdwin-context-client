...
@NotThreadSafe
public class TestSaveRestoreLayoutModelView extends AView<TestSaveRestoreLayoutModel, JPanel> {
    ...
    public TestSaveRestoreLayoutModelView(final TestSaveRestoreLayoutModel model) {
        super(model);
    }
    ...
    protected JPanel initComponent() {
        ...
        nextJButton.setIcon(new ImageIcon(new ImageIcon(
                TestSaveRestoreLayoutModelView.class.getResource("/de/invesdwin/context/client/swing/icon.png"))
                        .getImage()
