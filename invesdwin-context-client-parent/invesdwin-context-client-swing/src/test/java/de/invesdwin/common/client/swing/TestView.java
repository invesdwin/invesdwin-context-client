...
public class TestView extends AView<TestModel, JPanel> {
    ...
    protected JPanel initComponent() {
        ...
        table.setModel(new DefaultTableModel(new Object[][] { { null, null }, }, new String[] { "columnInteger",
                "columnString", "columnBoolean" }));
        ...
        nextJButton.setIcon(new ImageIcon(new ImageIcon(
                TestView.class.getResource("/de/invesdwin/common/client/swing/icon.png")).getImage().getScaledInstance(
