...
@NotThreadSafe
@Configurable
public class ShowViewMenuItem<V extends AView<?, ?>> extends JMenuItem {
    ...
    public ShowViewMenuItem(final Class<V> viewClass, final IWorkingAreaLocation location) {
        super();
    ...
    public ShowViewMenuItem<V> withCachingEnabled(final boolean cachingEnabled) {
